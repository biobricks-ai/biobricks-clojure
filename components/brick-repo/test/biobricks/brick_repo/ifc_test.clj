...
(deftest test-download-url
  (let [config {"core.remote" "biobricks.ai"
    ...
    (is (= "https://ins-dvc.s3.amazonaws.com/insdvc/files/md5/7e/b3a14caf5b488296355129862d62d0.dir"
    ...
    (is (= "https://ins-dvc.s3.amazonaws.com/insdvc/00/044973831d9a3bbe307dc46f436451"
           (brick-repo/download-url config "00044973831d9a3bbe307dc46f436451" :old-cache-location? true))
    ...
    (is (= "https://ins-dvc.s3.amazonaws.com/insdvc/7e/b3a14caf5b488296355129862d62d0.dir"
           (brick-repo/download-url config "7eb3a14caf5b488296355129862d62d0.dir" :old-cache-location? true))
